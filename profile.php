...
?>
    ...
    <section class="p-0 bg-light">
      <div class="image image-overlay image-cover" style="background-image:url(./assets/images/demo/minimal/cd-1.jpg)"
          ...
          <div class="col col-md-10 col-lg-8">
            <div class="row align-items-center">
              ...
              <div class="col">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h2 class="mb-0"><b>Yoruba</b> Samurai</h2>
                        <span class="text-muted">Enterpreneur</span>
                    </div>
                    <div class="col-md-4 text-left text-md-right">
                         <a href="#" class="btn btn-primary" role="button" data-bs-toggle="button">Log</a>
                    </div>
                     </div>
              </div>
            </div>
        ...
        <div class="row justify-content-center">
          <div class="col col-md-10 col-lg-8">
            <div class="nav nav-tabs mb-1">
              ...
              <!-- <a class="nav-item nav-link" data-toggle="tab" href="#demo-2-2">Number of Shoots</a>
              <a class="nav-item nav-link" data-toggle="tab" href="#demo-2-3">Refferals</a> -->
              <a class="nav-item nav-link" data-toggle="tab" href="#demo-2-4">Settings</a>
              <a class="nav-item nav-link" data-toggle="tab" href="#demo-2-5">Payment/Cashout</a>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div class="col-6 col-md-4 col-lg-3">
                    <div class="equal">
                      <div class="boxed">
                        ...
                        <div class="equal-footer">
                          <span class="text-muted">Refferals</span>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="card-body overflow-hidden">
                        <div class="owl-carousel gallery visible" data-items="[2,2]" data-margin="10" data-nav="true">
                          <figure class="photo equal equal-double">
                            <a href="./assets/images/demo/minimal/cd-1.jpg" title="Image title">
                              <img src="./assets/images/demo/minimal/s6.jpg" alt="Image">
                            </a>
                          </figure>
                          <figure class="photo equal equal-double">
                          <a href="./assets/images/demo/minimal/cd-1.jpg" title="Image title">
                              <img src="./assets/images/demo/minimal/s3.jpg" alt="Image">
                            </a>
                          </figure>
                          <figure class="photo equal equal-double">
                          <a href="./assets/images/demo/minimal/cd-1.jpg" title="Image title">
                              <img src="./assets/images/demo/minimal/cd-1.jpg" alt="Image">
                            </a>
                          </figure>
                        </div>
                      </div>
                ...
                <div class="row align-items-center mb-2">
                  ...
                  <div class="col-lg-6 text-center text-lg-right mt-1 mt-lg-0">
                    <div class="nav nav-switch">
                      ...
                      <a class="nav-item nav-link" id="second-tab" data-toggle="tab" href="#pricing-second">Paypal</a>
                    </div>
                  </div>
                </div>
                <div class="row">
                      ...
                      <div class="tab-pane" id="pricing-second" role="tabpanel" aria-labelledby="second-tab">
                        <div class="boxed p-3">
                          <form>
                            <div class="form-row">
                              <div class="col-8">
                                <input type="text" class="form-control form-control-minimal" placeholder="Paypal Mail">
                              </div>
                              <div class="col-4">
